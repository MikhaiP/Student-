...
class EncryptionManager : EncryptionInterface {
    ...
    @OptIn(ExperimentalEncodingApi::class)
    override fun decryptMessage(encryptedText: String, aesKey:SecretKey, aesIv: IvParameterSpec):String{
